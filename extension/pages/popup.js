    ...
    modal.innerHTML = `
      <div class="upgrade-modal-content">
        ...
        <div class="upgrade-actions">
          <a href="${CONFIG.webAppUrl}/upgrade?source=extension" target="_blank" class="btn-upgrade">
            Upgrade to Pro
          </a>
      ...
      if (userState.userId) {
        ...
        elements.accountSection.innerHTML = `
          <div class="account-prompt">
            ...
            <a href="${CONFIG.webAppUrl}/login?source=extension" target="_blank" class="btn-connect">
              Connect Account
            </a>
          </div>
        `;

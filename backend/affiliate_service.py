...
RETAILERS: Dict[str, RetailerConfig] = {
    'CA': RetailerConfig(
        ...
        affiliate_id=os.environ.get('INDIGO_AFFILIATE_ID', 'quirrely'),
    ...
    'UK': RetailerConfig(
        ...
        affiliate_id=os.environ.get('WATERSTONES_AWIN_ID', 'quirrely'),
    ...
    'AU': RetailerConfig(
        ...
        affiliate_id=os.environ.get('BOOKTOPIA_AFFILIATE_ID', 'quirrely'),
    ...
    'NZ': RetailerConfig(
        ...
        affiliate_id=os.environ.get('MIGHTYAPE_AFFILIATE_ID', 'quirrely'),
    ...
    'US': RetailerConfig(
        ...
        search_template='https://bookshop.org/search?keywords={query}&aff_id={affiliate_id}',
        product_template='https://bookshop.org/p/books/{isbn}?ean={isbn}&aff_id={affiliate_id}',
        affiliate_id=os.environ.get('BOOKSHOP_AFFILIATE_ID', 'quirrely'),
        affiliate_network='bookshop',
        commission_rate=0.10,
        currency='USD',
        cta='Buy at Bookshop.org',
        color='#3B82F6'
    )
}

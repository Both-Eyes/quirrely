...
async def sign_up(request: SignUpRequest):
    """Sign up with email (password optional for magic link flow)."""
    ...
    if request.password:
        validation = PASSWORD_POLICY.validate(request.password)
    ...
    _users[user_id] = {
        ...
        "password_hash": request.password,  # Would hash in production
        "display_name": None,
...
async def login(request: LoginRequest):
    ...
    # Check password (would use proper hashing in production)
